...
ToggleRectangleTool() {
    ...
    if (rectGui) {
        ...
        IniWrite, %rectX%, config.ini, Rectangle, x
        IniWrite, %rectY%, config.ini, Rectangle, y
        IniWrite, %rectW%, config.ini, Rectangle, width
        IniWrite, %rectH%, config.ini, Rectangle, height

        ; 強制轉成 ANSI 編碼
        ForceConvertToANSI("config.ini")
...
CreateRectangle() {
    ...
    ; 读取配置
    IniRead, savedX, config.ini, Rectangle, x, 100
    IniRead, savedY, config.ini, Rectangle, y, 100
    IniRead, savedW, config.ini, Rectangle, width, 300
    IniRead, savedH, config.ini, Rectangle, height, 200
